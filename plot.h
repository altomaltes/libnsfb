 ...
 */
typedef bool (nsfb_plotfn_pan_t)( nsfb_t *nsfb, int type );
 ...
 */
typedef bool (nsfb_plotfn_line_t)(nsfb_t *nsfb, int linec, nsfb_bbox_t *line, nsfbPlotpen_t *pen);
...
/** Plot bitmap
 */
typedef bool ( nsfb_plotfn_bitmap_t )( nsfb_t *nsfb
...
/** Plot tiled bitmap
 */
typedef bool (nsfb_plotfn_bitmap_tiles_t)( nsfb_t *nsfb
 ...
 */
typedef bool (nsfb_plotfn_glyph8_t)(nsfb_t *nsfb, nsfb_bbox_t *loc, const byte *pixel, int pitch, nsfb_colour_t c, nsfb_colour_t b );


/** Plot an 1 bit per pixel glyph.
 */
typedef bool (nsfb_plotfn_glyph1_t)(nsfb_t *nsfb, nsfb_bbox_t *loc, const byte *pixel, int pitch, nsfb_colour_t c);

/** Read rectangle of screen into buffer
 */
typedef	bool ( nsfb_plotfn_readrect_t )( nsfb_t *, nsfb_bbox_t *rect, nsfb_colour_t *buffer);

/** Move rectangle of screen
 */
typedef	int ( nsfb_plotfn_moverect_t )( nsfb_t *, int  w, int h, int x, int y );

/** Plot quadratic bezier spline
 */
typedef bool ( nsfb_plotfn_quadratic_bezier_t)(nsfb_t *, nsfb_bbox_t *curve, nsfb_point_t *ctrla, nsfbPlotpen_t *pen);

/** Plot cubic bezier spline
 */
typedef bool ( nsfb_plotfn_cubic_bezier_t    )(nsfb_t *, nsfb_bbox_t *curve, nsfb_point_t *ctrla, nsfb_point_t *ctrlb, nsfbPlotpen_t *pen);

typedef bool ( nsfb_plotfn_polylines_t       )(nsfb_t *, int pointc, const nsfb_point_t *points, nsfbPlotpen_t *pen);

/** plot path */
typedef bool ( nsfb_plotfn_path_t            )(nsfb_t *, int pathc, nsfbPlotpathop_t *pathop, nsfbPlotpen_t *pen);
...
{ nsfb_plotfn_clg_t              * clg;
  ...
  nsfb_plotfn_moverect_t         * moverect;
